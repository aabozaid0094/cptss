...
class CPTSS_Sanitize {
	...
	public function clean() {
		 ...
		 */
		do_action( 'cptss_pre_sanitize', $sanitized );
		 ...
		 */
		do_action( 'cptss_post_sanitize', $sanitized );
	...
	public function set_type( $type ) {
		...
		if ( empty( $type ) ) {
			...
			$check = new WP_Error( 'forgot_type', __( 'Specify the data type to sanitize.', 'cptss' ) );

		}

		if ( is_wp_error( $check ) ) {

			wp_die( $check->get_error_message(), __( 'Forgot data type', 'cptss' ) );
